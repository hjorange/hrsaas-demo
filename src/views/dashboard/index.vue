  ...
  <div class="dashboard-container">
      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">早安，{{ UserInfo.username }}|{{ UserInfo.companyName }}-{{ UserInfo.departmentName }}，祝你开心每一天！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="离职日期" prop="exceptTime">
          <el-date-picker v-model="form.exceptTime" value-format="yyyy-MM-dd HH-mm-ss" type="datetime" placeholder="选择日期" style="width: 100%;" />
        </el-form-item>
...
import WordDate from './components/WordDate.vue'
